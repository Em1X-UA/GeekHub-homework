...
def slp():
    """
    Waiting func for returning after errors
    """
...
def get_user_input():
    """
    Getting value from user and determine number type.
    """
...
def check_file(file):
    """
    Check DB file exists, and possibility to create default, if not.
    """
...
def determine_value(num):
    """
    Determine and returns number type int or float
    """
