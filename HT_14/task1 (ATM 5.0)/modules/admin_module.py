...
class Admin:
    ...
    def check_banknotes(self):
        """
        Prints all banknotes nominal | quantity in ATM.
        """
    ...
    def change_banknotes_balance_menu(self):
        """
        Menu for changing banknotes quantity.
        """
        ...
        return self.back_main_menu()

    def check_logs(self):
        """
        Print logs for current admin/collector.
        """
